...
const inputField = (errorMessage, setErrorMessage, editMode, title, setValue, value, valueName, arrowPath, setValueForSaving, setModalVisible, index, setIndex, saveCart, name, image, distance, width, length) => {
        ...
        <View style={{width: "100%", height: "100%", justifyContent: "center", alignItems: "center"}}>
            ...
            <View style={{ position: "absolute", right: marginOfIcons, bottom: marginOfIcons}}>     
             {createCart ? <TouchableOpacity onPress={() => {
                    ...
                    setErrorMessage("")
                    saveCart(name, image, distance, width, length); 
            ...
            <View style={{width: "100%", height: "100%", flexDirection: "row"}}>
                <View style={styles.imageField}>                 
                        <View style={styles.ImagePreview}>
                            ...
                            <Text style={styles.label}>Choose an Image{"\n"} {"(Optional)"}</Text>}
                        </View>
                </View>
                <View style={styles.imageField}>                 
                    <TouchableOpacity style={styles.imageOptions} onPress={ () => choosePhotoFromLibrary(setValue, setValueForSaving)}>
                        <View style={styles.imageOptionLabels}>
                            <Text style={styles.imageOptionsLabelText}>Find an image in your gallery</Text>
                        </View>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.imageOptions} onPress={ () =>  takeImage(setValue, setValueForSaving)}>
                        <View style={styles.imageOptionLabels} >
                            <Text style={styles.imageOptionsLabelText}>Take a new picture</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                {!editMode ?
...
const CreateCartPages = props => {
    ...
    var arrayTest =
        [
            inputField(errorMessage, setErrorMessage, props.editMode, "Pleace Choose a name for the cart", props.setNameValue, props.nameValue, "Name", require("../images/CartCreations/HeightArrow.png"), setName, props.setModalVisible, props.index, props.setIndex),
            ...
            inputField(errorMessage, setErrorMessage, props.editMode, "How long is the carts towbar?", props.setDistanceValue, props.distanceValue, "Distance", require("../images/CartCreations/HeightArrow.png"), setDistance, props.setModalVisible, props.index, props.setIndex, props.saveCart), 
            inputField(errorMessage, setErrorMessage, props.editMode, "What is the width of your cart?", props.setWidthValue, props.widthValue, "Width", require("../images/CartCreations/WidthArrow.png"), setWidth,props.setModalVisible, props.index, props.setIndex, props.saveCart),
            inputField(errorMessage, setErrorMessage, props.editMode, "please indicate the length of the cart", props.setLengthValue, props.lengthValue, "Length", require("../images/CartCreations/LengthArrow.png"), setLength, props.setModalVisible, props.index, props.setIndex, props.saveCart, name, image, distance, width, length),
        ]
    ...
    useEffect(() => {
        ...
        arrayTest =  [
            inputField(errorMessage, setErrorMessage, props.editMode, "Pleace Choose a name for the cart",  props.setNameValue, props.nameValue, "Name", require("../images/CartCreations/HeightArrow.png"), setName, props.setModalVisible, props.index, props.setIndex,),
            chooseImageField(props.editMode, choosePhotoFromLibrary, takeImage, props.imageValue, props.setImageValue, setImage, props.index, props.setIndex, props.setModalVisible),
            inputField(errorMessage, setErrorMessage, props.editMode, "How long is the hitch of the cart?", props.setDistanceValue, props.distanceValue, "Distance", require("../images/CartCreations/HeightArrow.png"), setDistance, props.setModalVisible, props.index, props.setIndex, props.saveCart), 
            inputField(errorMessage, setErrorMessage, props.editMode, "What is the width of the elevator you want to use?", props.setWidthValue, props.widthValue, "Width", require("../images/CartCreations/WidthArrow.png"), setWidth,props.setModalVisible, props.index, props.setIndex, props.saveCart), 
            inputField(errorMessage, setErrorMessage, props.editMode, "please indicate the length of the cart", props.setLengthValue, props.lengthValue, "Length", require("../images/CartCreations/LengthArrow.png"), setLength, props.setModalVisible, props.index, props.setIndex, props.saveCart, image, distance, width, length),
        ]
